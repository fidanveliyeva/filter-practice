...
domRender(filteredProduct)
} else{
    productsElem.innerHTML = '<img src = "https://thumbs.dreamstime.com/b/product-not-available-icon-flat-isolated-vector-eps-illustration-minimal-design-long-shadow-118523643.jpg">'
}
})

function domRender(param){
productsElem.innerHTML = ""
    param.forEach(item =>  productsElem.innerHTML += `
        <div class="product">
